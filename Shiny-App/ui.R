    ...
    sidebarLayout(
      sidebarPanel(
        selectInput("plot_ob","Select what to plot",c("a barchart of eigenvalues"="a",
                                                      ...
                                                      "a scatterplot of partial factor & loadings"="d",
                                                      "a bootstrap ratio plot"="e",
                                                      "a bootstrap confidence ellipses plot")),
        #Choose the two dimensions to plot
        sliderInput("dim_1","The first Dimension to Plot",min=1,max=11,value=4),
        sliderInput("dim_2","The second Dimension to Plot",min=1,max=11,value=5)
      ),
